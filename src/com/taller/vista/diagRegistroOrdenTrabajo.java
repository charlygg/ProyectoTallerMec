 ...
 * @author Usuario
 */
public class diagRegistroOrdenTrabajo extends javax.swing.JDialog {
    ...
    public diagRegistroOrdenTrabajo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);        
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(diagRegistroOrdenTrabajo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                diagRegistroOrdenTrabajo dialog = new diagRegistroOrdenTrabajo(new javax.swing.JFrame(), true);
