 ...
 * @author Usuario
 */
public class diagRegistroEmpleadosLista extends javax.swing.JDialog {
    ...
    public int obtenerEmpleadoSeleccionado(){
    ...
    public diagRegistroEmpleadosLista(java.awt.Frame parent, boolean modal) {
        super(parent, modal);        
        EmpleadoDao dat = new EmpleadoDao();
        tableModel = new DefaultTableModel(columnas, 0);
        ArrayList<Empleado> listadoEmpleados = new ArrayList<Empleado>();
        listadoEmpleados = dat.obtenerAllEmpleados();  
        ...
        for(Empleado e : listadoEmpleados){
            ...
            fila.add(e.getIdEmpleado());
            fila.add(e.getNombre());
            fila.add(e.getApePat());
            fila.add(e.getApeMat());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(diagRegistroEmpleadosLista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                diagRegistroEmpleadosLista dialog = new diagRegistroEmpleadosLista(new javax.swing.JFrame(), true);
