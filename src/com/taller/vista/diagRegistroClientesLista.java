 ...
 * @author Usuario
 */
public class diagRegistroClientesLista extends javax.swing.JDialog {
    ...
    public diagRegistroClientesLista(java.awt.Frame parent, boolean modal) {
        super(parent, modal);        
        ...
        for(Cliente c : listadoClientes){
            ...
            fila.add(c.getNombreCompleto());
            fila.add(c.getCompania());
            fila.add(c.getRfc());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(diagRegistroClientesLista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                diagRegistroClientesLista dialog = new diagRegistroClientesLista(new javax.swing.JFrame(), true);
