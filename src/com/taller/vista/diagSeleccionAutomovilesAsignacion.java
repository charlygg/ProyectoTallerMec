 ...
 * @author Usuario
 */
public class diagSeleccionAutomovilesAsignacion extends javax.swing.JDialog {
    ...
    public diagSeleccionAutomovilesAsignacion(java.awt.Frame parent, boolean modal) {
        super(parent, modal);        
        AutomovilDao dat = new AutomovilDao();
        tableModel = new DefaultTableModel(columnas, 0);
        ArrayList<Automovil> listadoAutos = new ArrayList<Automovil>();
        listadoAutos = dat.obtenerAutomovovilesFromClienteId(-1);            
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(diagSeleccionAutomovilesAsignacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                diagSeleccionAutomovilesAsignacion dialog = new diagSeleccionAutomovilesAsignacion(new javax.swing.JFrame(), true);
